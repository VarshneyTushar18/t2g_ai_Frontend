...
export function HireOpenAIPage() {
    const scrollToContact = () => {
        const el = document.querySelector("#openai-contact-form");
    ...
    return (
        <div>
            ...
            {/* ── Contact Form ─────────────────────────────── */}
            <section
                id="openai-contact-form"
                className="py-12 border-t border-border"
                style={{ background: "#f5f3ff" }}
                data-ocid="openai-contact.section"
            >
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center max-w-2xl mx-auto mb-6">
                        <motion.div
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-4">
                                Start Your OpenAI Project Today
                            </h2>
                            <p className="text-base text-muted-foreground font-body">
                                Fill in your details and one of our OpenAI experts will get back
                            ...
                            {[
                                ...
                                return (
                                    <div
                                        ...
                                        data-ocid={`openai-contact.info.${i + 1}`}
                                    >
                                        <div
